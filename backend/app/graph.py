...
BASELINE_GRAPH: dict[str, list[dict[str, Any]]] = {
    ...
    "edges": [
        ...
        {"id": "e_gym_business", "from": "gym", "to": "school_business", "distance": 18, "base_risk": 0.16, "dynamic_risk": 0.0, "status": "open"},
        {"id": "e_quad_business", "from": "quad", "to": "school_business", "distance": 20, "base_risk": 0.14, "dynamic_risk": 0.0, "status": "open"},
        ...
        {"id": "e_business_dorms", "from": "school_business", "to": "dorms", "distance": 28, "base_risk": 0.18, "dynamic_risk": 0.0, "status": "open"},
